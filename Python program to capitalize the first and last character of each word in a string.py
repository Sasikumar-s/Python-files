...
for n in str2:
    find_n=n[-1]    #Find last letter in each word --> i,r
    a=n[-1].upper() #change last word into capitalize  -->I,R
    fin=n.replace(find_n,a) #Replace that letter in list-->Chage i to I and r to R
    l.append(fin)   #append the string  -->['SasI','KumaR']
